...
format:
  html:
    css: [critical-image-fix.css, projects-fix.css, project-card-custom.css, title-hard-fix.css, card-hover-animation.css]
listing:
  contents: 
    - "posts/*.qmd"
    - "!posts/*.ipynb"
...
<!-- Fix card hover animation glitches and make entire card clickable -->
<script src="js/smooth-card-hover.js"></script>
